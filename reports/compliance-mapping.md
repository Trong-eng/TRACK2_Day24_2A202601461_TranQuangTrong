...
|---|---|---|
| Luật 91/2025 — quyền yêu cầu xoá | Quyền yêu cầu xoá dữ liệu cá nhân (Right to erasure / Delete cascade) & bảo toàn ledger | `agent/tools.py:L68-L83`, `tests/test_delete_cascade.py` |
